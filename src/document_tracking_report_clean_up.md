...
- Para ello ir a la opcion Reports > Policy > Document Tracking `app/reports/document-tracking`
...
``` 
_Aqui vas a ver que algunos STATE no sera **COMPLETED**, lo cual es el error o el problema que se tiene que solucionar_

### Solucion

- Del siquiente script, se tiene que cambiar la lista de policies number por la que viene en el ticket, y luego ejecutarlo en la db de **LISO**.
- [script](../db/Document_Tracking_Report_Clean_Up.sql)
